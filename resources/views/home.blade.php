...
<div class="row">
    <div class="col-xl-4">
            ...
            <div class="card-body pt-0">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <p class="mb-0 text-truncate">{{$data->position}}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-5">TASKS</h4>
                <div class="">
    ...
    <div class="col-xl-8">
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="fw-medium mb-2">Completed Tasks</p>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="fw-medium mb-2">On Proggress</p>
                                <h4 class="mb-0">12</h4>
                            </div>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="fw-medium mb-2">Pending</p>
                                <h4 class="mb-0">0</h4>
                            </div>
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">My Attendance</h4>
                <div class="table-responsive">
